...
const BROWSER_PACKAGE_IDENTITY_PATHS = Object.freeze({
  ...
  browser_runtime_source: "crates/bevy_image/src/browser_boogu/runtime.rs",
...
export async function collectBrowserPackageIdentity({
  ...
  const fileInputs = {
    ...
    browser_runtime_source: join(repoRoot, "crates/bevy_image/src/browser_boogu/runtime.rs"),
