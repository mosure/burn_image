...
pub use artifacts::{
    ...
    FLUX_VAE_COMPONENT_ROLE, FLUX_VAE_DECODER_STAGE, FLUX_VAE_ENCODER_STAGE,
    FLUX_VAE_SHARED_COMPONENT_BUNDLE_ID, FLUX_VAE_SHARED_COMPONENT_CONTENT_DIGEST,
    FluxVaeArtifactError, FluxVaeArtifactFloatPolicy, FluxVaeComponentContract, FluxVaeStageSource,
    ...
    flux_vae_component_dependency, flux_vae_shared_component_dependency,
};
pub use blocks::{
